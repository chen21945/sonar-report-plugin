...
import org.sonarsource.plugins.report.support.pdf.Events;
import org.sonarsource.plugins.report.support.pdf.Header;
...
public class Toc extends PdfPageEventHelper {
  ...
  public void onChapter(final PdfWriter writer, final Document document, final float position,
    ...
    content
        .addCell(new Phrase(title.getContent(), new Font(Font.FontFamily.HELVETICA, 11)));
  ...
  public void onSection(final PdfWriter writer, final Document document, final float position,
    ...
    case 2:
      ...
      content.addCell(new Phrase(title.getContent(), new Font(Font.FontFamily.HELVETICA,
          10)));
