...
//    public static final String GENERAL_VIOLATIONS_DASHBOARD = "general.violationsDashboard";
    ...
    public static final String GENERAL_DICTIONARIES = "general.dictionaries";

    public static final String GENERAL_COMPLEXITY = "general.complexity";
    public static final String GENERAL_COGNITIVE_COMPLEXITY= "general.cognitive.complexity";
